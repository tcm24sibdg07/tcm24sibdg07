...
let EstadoRepository = class EstadoRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Estado, dataSource);
    }
};
exports.EstadoRepository = EstadoRepository;
exports.EstadoRepository = EstadoRepository = tslib_1.__decorate([
